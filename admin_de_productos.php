...
<body id="body-admin">
      ...
      <nav class="navbar navbar-expand-lg navbar-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link" href="admin_de_productos.php"><img src="img/carrito.png" alt="50" height="30px"></a>
            </li>
            <!-- menu hamburguesa -->
            <li class="nav-item">
  ...
  <!-- CONTENIDO PRINCIPAL -->
  <h1 class="text-center p-3">Productos listados</h1>
  <div class="container-fluid row">
    <form class="col-4" method="POST">
      ...
      <div class="mb-3">
        ...
        <select type="text" class="form-control" id="stock" name="stock" placeholder="stock" required-value="">
          <option value="text"></option>
          <option value="user">Disponible</option>
          <option value="admin">Agotado</option>
        </select>
      </div>
      <button type="submit" class="btn btn-primary" name="btnregistrarProducto" value="ok">Registrar</button>
    </form>
    <div class="col-8 p-4">
      <table class="table table-striped table-hover">
        ...
        <tbody>
          ...
          include "phpControlador/eliminar_productos.php";

          include "phpcontrolador/admin_registrar_producto.php";
          ...
          while ($datos = $consulta->fetch_assoc()) {
            ...
            <tr>
              ...
              <td><a href="modificar_productos.php?id_producto=<?php echo $datos["id_producto"]; ?>"
                  class="btn btn-small btn-warning"><i class="fa-solid fa-pen-to-square"></i></td>

              <td><a onclick="return eliminar"
                  href="admin_de_productos.php?id_producto=<?php echo $datos["id_producto"]; ?>"
